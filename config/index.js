export const USER_CONFIG = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: "wxe135562332ad75b5",
  
  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: "026dee84fda0a8d80d8fc3555bad8e5e",
  ...
  USERS: [
    {
      ...
      // 你想对他发送的模板消息的模板ID
      useTemplateId: "t95fgdP5cd_97B9XRksJ31elgaU8FxXSx2TLvhraDsE",
      // 所在省份
      province: "湖北",
      // 所在城市
      city: "荆门",
  ...
  CALLBACK_TEMPLATE_ID: "ymLUrOWVGsYvA8Ffzl6M-gakuTP2ekEvEI_qkZjmO9Q",
  ...
  FESTIVALS: [
    // 注意：此条配置日期为阴历日期，因为`type`中 “生日” 之前有 * 符号
    {"type": "*生日", "name": "阿星", "year": "1997", "date": "10-27", isShowAge: true},
